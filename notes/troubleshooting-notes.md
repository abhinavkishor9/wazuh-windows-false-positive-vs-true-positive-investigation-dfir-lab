...
- A false positive is still a real event; the incorrect part is the malicious interpretation.
- A true positive should be supported by multiple pieces of evidence.
- Suspicious strings should trigger investigation, not automatic escalation.
- Wazuh field names should be verified against actual indexed events.
- Windows, Sysmon, and Wazuh should be correlated rather than investigated independently.
- Alert disposition should always be documented with a clear evidence-based justification.
